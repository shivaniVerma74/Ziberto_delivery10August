...
const Color primary = Color(0xff9ECB3D);
const Color secondary=Color(0xffFDCD96);
const Color fontColor=Color(0xff111111);
const Color grad1Color=Color(0xffFFBD69);
const Color grad2Color=Color(0xff9ECB3D);
