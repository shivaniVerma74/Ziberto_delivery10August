                        ...
                        orderList.isEmpty
                          ...
                          itemBuilder: (context, index) {
                            return (index == orderList.length &&
                                ...
                                : orderList[index].itemList!.isNotEmpty ? orderItem(index) : const Center(child: Text(noItem));
                          },
                        )
                      ])))
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              ListTile(
                ...
                title: Text("On / Off"),
                trailing: Switch(value: onOf, onChanged: (val){
                  setState(() {
                    onOf = val;
                    deliStatus();
                  });
